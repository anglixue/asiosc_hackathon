...
scrna <- readRDS("../../results/sc2marker.case.scrna.intermediate.rds")
markers.all <- readRDS("../../results/sc2marker.case.allmarkers.intermediate.rds")
```

This part of results is based on healthy control only.
