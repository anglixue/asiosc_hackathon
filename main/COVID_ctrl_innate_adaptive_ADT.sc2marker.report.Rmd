...
scrna <- readRDS("../../results/sc2marker.ctrl.scrna.intermediate.rds")
markers.all <- readRDS("../../results/sc2marker.ctrl.allmarkers.intermediate.rds")
```

This part of results is based on COVID patients only.
