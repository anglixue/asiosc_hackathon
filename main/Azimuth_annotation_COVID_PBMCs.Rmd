...
rna1 = readRDS("../data/Liu_et_al_Cell_2021_COVID/10_1016_j_cell_2021_02_018_adaptive_rna.rds")
rna2 = readRDS("../data/Liu_et_al_Cell_2021_COVID/10_1016_j_cell_2021_02_018_innate_rna.rds")

prot1 = readRDS("../data/Liu_et_al_Cell_2021_COVID/10_1016_j_cell_2021_02_018_adaptive_protein.rds")
prot2 = readRDS("../data/Liu_et_al_Cell_2021_COVID/10_1016_j_cell_2021_02_018_innate_protein.rds")
...
cbmc <- CreateSeuratObject(counts = rna2@assays$RNA@data)
# Add the ADT assay to the RNA Seurat object
adt_assay <- CreateAssayObject(counts = prot2@assays$ADT@counts)
cbmc[["ADT"]] <- adt_assay

# The RunAzimuth function can take a Seurat object as input
# The ADT assay stands for "antibody-derived tags"
DefaultAssay(cbmc) <- "ADT"
data1 <- RunAzimuth(cbmc, assay = "ADT", reference = "pbmcref")
```
...
cbmc@reductions = prot2@reductions
cbmc@meta.data$cell_type = prot2@meta.data$cell_type
cbmc@meta.data$ethnicity = prot2@meta.data$ethnicity

p1 <- DimPlot(cbmc, group.by = "cell_type", label = TRUE, label.size = 3) + NoLegend()
p2 <- DimPlot(cbmc, group.by = "ethnicity")
p1 + p2
```
